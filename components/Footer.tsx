    ...
    <footer className="bg-warm-ivory text-charcoal py-12" style={{borderTop: '1px solid rgba(214,179,106,0.06)'}}>
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm">Email: <a href="mailto:hello@weddingstation.example" className="underline text-charcoal">hello@weddingstation.example</a></p>
          <p className="mt-2 text-sm">Phone: <a href="tel:+911234567890" className="underline text-charcoal">+91 12345 67890</a></p>
          <div className="mt-4 flex items-center gap-4">
            ...
            <a href="#" aria-label="WhatsApp" className="text-charcoal">WhatsApp</a>
          </div>
        </div>
      </div>

      <div className="mt-12 text-center text-xs text-charcoal">© 2026 Wedding Station — All rights reserved.</div>
    </footer>
  );
}
